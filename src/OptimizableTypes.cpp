...
namespace ORB_SLAM3 {
    ...
    EdgeSim3ProjectXYZ::EdgeSim3ProjectXYZ(Sophus::SE3d Tc) :
            g2o::BaseBinaryEdge<2, Eigen::Vector2d, g2o::VertexSBAPointXYZ, VertexSim3Expmap>(), mTc(Tc)
    {
    }
    ...
    EdgeInverseSim3ProjectXYZ::EdgeInverseSim3ProjectXYZ(Sophus::SE3d Tc) :
            g2o::BaseBinaryEdge<2, Eigen::Vector2d, g2o::VertexSBAPointXYZ, VertexSim3Expmap>(), mTc(Tc)
    {
    }
    ...
    EdgeSim3XYZ::EdgeSim3XYZ() : g2o::BaseBinaryEdge<3, Eigen::Vector3d,  g2o::VertexSBAPointXYZ, VertexSim3Expmap>(){
